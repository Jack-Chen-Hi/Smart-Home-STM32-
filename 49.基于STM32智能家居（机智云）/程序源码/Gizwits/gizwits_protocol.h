...
* @{
*/
#define PRODUCT_KEY "11b7144cb27346eaafb3613cc70c7527"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "e61a3789945645b2a248dc2f7a982614"
...
#define GZ_Value_MAX                           4096
#define MQ2_Value_RATIO                         1
#define MQ2_Value_ADDITION                      0
#define MQ2_Value_MIN                           0
#define MQ2_Value_MAX                           4096
#define MQ7_Value_RATIO                         1
#define MQ7_Value_ADDITION                      0
#define MQ7_Value_MIN                           0
#define MQ7_Value_MAX                           4096
#define MQ135_Value_RATIO                         1
#define MQ135_Value_ADDITION                      0
#define MQ135_Value_MIN                           0
#define MQ135_Value_MAX                           4096
/**@} */
...
typedef struct {
  ...
  uint32_t valueMQ2_Value;
  uint32_t valueMQ7_Value;
  uint32_t valueMQ135_Value;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t flagHum:1;
  uint8_t flagPre:1;
  uint8_t flagGZ_Value:1;
  uint8_t flagMQ2_Value:1;
  uint8_t flagMQ7_Value:1;
  uint8_t flagMQ135_Value:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint16_t valueMQ2_Value;
  uint16_t valueMQ7_Value;
  uint16_t valueMQ135_Value;
} attrVals_t;
