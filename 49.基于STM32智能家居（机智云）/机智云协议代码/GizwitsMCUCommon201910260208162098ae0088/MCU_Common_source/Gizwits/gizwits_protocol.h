...
* @{
*/
#define PRODUCT_KEY "8ae00882fc0b4dbcac7de59c9d0fa6cd"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c6e08bfa7d9f4bc48f60576fe350bced"
...
#define Pre_MIN                           0
#define Pre_MAX                           2000
#define PM_2_5_RATIO                         1
#define PM_2_5_ADDITION                      0
#define PM_2_5_MIN                           0
#define PM_2_5_MAX                           4096
#define M5_Value_RATIO                         1
#define M5_Value_ADDITION                      0
#define M5_Value_MIN                           0
#define M5_Value_MAX                           4096
#define M135_Val_RATIO                         1
#define M135_Val_ADDITION                      0
#define M135_Val_MIN                           0
#define M135_Val_MAX                           4096
/**@} */
...
typedef struct {
  ...
  uint32_t valueFS;
  uint32_t valuePre;
  uint32_t valuePM_2_5;
  uint32_t valueM5_Value;
  uint32_t valueM135_Val;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t flagFS:1;
  uint8_t flagPre:1;
  uint8_t flagPM_2_5:1;
  uint8_t flagM5_Value:1;
  uint8_t flagM135_Val:1;
} attrFlags_t;
...
typedef struct {
  ...
  uint8_t valueFS;
  uint16_t valuePre;
  uint16_t valuePM_2_5;
  uint16_t valueM5_Value;
  uint16_t valueM135_Val;
} attrVals_t;
