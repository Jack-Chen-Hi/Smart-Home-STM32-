  ...
  for(i=0; i<info->num; i++)
  {
    switch(info->event[i])
    {
      ...
      case EVENT_Hum:
        ...
        break;
      case EVENT_FS:
        currentDataPoint.valueFS = dataPointPtr->valueFS;
        GIZWITS_LOG("Evt:EVENT_FS %d\n",currentDataPoint.valueFS);
        //user handle
        break;
      case EVENT_Pre:
        ...
        break;
      case EVENT_PM_2_5:
        currentDataPoint.valuePM_2_5 = dataPointPtr->valuePM_2_5;
        GIZWITS_LOG("Evt:EVENT_PM_2_5 %d\n",currentDataPoint.valuePM_2_5);
        //user handle
        break;
      case EVENT_M5_Value:
        currentDataPoint.valueM5_Value = dataPointPtr->valueM5_Value;
        GIZWITS_LOG("Evt:EVENT_M5_Value %d\n",currentDataPoint.valueM5_Value);
        //user handle
        break;
      case EVENT_M135_Val:
        currentDataPoint.valueM135_Val = dataPointPtr->valueM135_Val;
        GIZWITS_LOG("Evt:EVENT_M135_Val %d\n",currentDataPoint.valueM135_Val);
        //user handle
        break;
