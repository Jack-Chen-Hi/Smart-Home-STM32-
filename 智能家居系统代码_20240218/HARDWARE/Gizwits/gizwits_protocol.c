...
static int8_t ICACHE_FLASH_ATTR gizCheckReport(dataPoint_t *cur, dataPoint_t *last)
{
    ...
    if(last->valueDHT11_Temp != cur->valueDHT11_Temp)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueDHT11_Temp Changed\n");
            ret = 1;
        }
    }
    if(last->valueDHT11_Hum != cur->valueDHT11_Hum)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valueDHT11_Hum Changed\n");
            ret = 1;
        }
    }
    ...
    if(last->valuem2_value != cur->valuem2_value)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valuem2_value Changed\n");
            ret = 1;
        }
    }
    if(last->valuem7_value != cur->valuem7_value)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valuem7_value Changed\n");
            ret = 1;
        }
    }
    if(last->valuem135_value != cur->valuem135_value)
    {
        if(currentTime - lastReportTime >= REPORT_TIME_MAX)
        {
            GIZWITS_LOG("valuem135_value Changed\n");
            ret = 1;
        }
    }
...
static int8_t ICACHE_FLASH_ATTR gizDataPoints2ReportData(dataPoint_t *dataPoints , devStatus_t *devStatusPtr)
{
    ...
    devStatusPtr->valueDHT11_Temp = gizY2X(DHT11_Temp_RATIO,  DHT11_Temp_ADDITION, dataPoints->valueDHT11_Temp); 
    devStatusPtr->valueDHT11_Hum = gizY2X(DHT11_Hum_RATIO,  DHT11_Hum_ADDITION, dataPoints->valueDHT11_Hum); 
    ...
    devStatusPtr->valuem2_value = exchangeBytes(gizY2X(m2_value_RATIO,  m2_value_ADDITION, dataPoints->valuem2_value)); 
    devStatusPtr->valuem7_value = exchangeBytes(gizY2X(m7_value_RATIO,  m7_value_ADDITION, dataPoints->valuem7_value)); 
    devStatusPtr->valuem135_value = exchangeBytes(gizY2X(m135_value_RATIO,  m135_value_ADDITION, dataPoints->valuem135_value)); 
