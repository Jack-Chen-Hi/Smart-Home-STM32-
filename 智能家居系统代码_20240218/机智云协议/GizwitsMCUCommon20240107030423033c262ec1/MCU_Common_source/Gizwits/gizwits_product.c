...
{
 /*
    currentDataPoint.valueDHT11_Temp = ;//Add Sensor Data Collection
    currentDataPoint.valueDHT11_Hum = ;//Add Sensor Data Collection
    currentDataPoint.valuePre = ;//Add Sensor Data Collection
    currentDataPoint.valuegz_value = ;//Add Sensor Data Collection
    currentDataPoint.valuem2_value = ;//Add Sensor Data Collection
    currentDataPoint.valuem7_value = ;//Add Sensor Data Collection
    currentDataPoint.valuem135_value = ;//Add Sensor Data Collection
...
void userInit(void)
{
    ...
    currentDataPoint.valueled = ;
    currentDataPoint.valuemotor = ;
    currentDataPoint.valueDHT11_Temp = ;
    currentDataPoint.valueDHT11_Hum = ;
    currentDataPoint.valuePre = ;
    currentDataPoint.valuegz_value = ;
    currentDataPoint.valuem2_value = ;
    currentDataPoint.valuem7_value = ;
    currentDataPoint.valuem135_value = ;
    */
