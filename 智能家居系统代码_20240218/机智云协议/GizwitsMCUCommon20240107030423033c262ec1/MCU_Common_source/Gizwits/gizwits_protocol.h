...
* @{
*/
#define PRODUCT_KEY "c262ec13a9d7412b961d2a9c1a3b1fd6"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "4a80bafc5616485a866aed1492f40080"
...
#define motor_BITOFFSET                     1
#define motor_LEN                           1

#define DHT11_Temp_RATIO                         1
#define DHT11_Temp_ADDITION                      0
#define DHT11_Temp_MIN                           0
#define DHT11_Temp_MAX                           100
#define DHT11_Hum_RATIO                         1
#define DHT11_Hum_ADDITION                      0
#define DHT11_Hum_MIN                           0
#define DHT11_Hum_MAX                           100
#define Pre_RATIO                         1
#define Pre_ADDITION                      0
#define Pre_MIN                           0
#define Pre_MAX                           4095
#define gz_value_RATIO                         1
#define gz_value_ADDITION                      0
#define gz_value_MIN                           0
#define gz_value_MAX                           4095
#define m2_value_RATIO                         1
#define m2_value_ADDITION                      0
#define m2_value_MIN                           0
#define m2_value_MAX                           4095
#define m7_value_RATIO                         1
#define m7_value_ADDITION                      0
#define m7_value_MIN                           0
#define m7_value_MAX                           4095
#define m135_value_RATIO                         1
#define m135_value_ADDITION                      0
#define m135_value_MIN                           0
#define m135_value_MAX                           4095
/**@} */
...
typedef struct {
    bool valueled;
    bool valuemotor;
    uint32_t valueDHT11_Temp;
    uint32_t valueDHT11_Hum;
    uint32_t valuePre;
    uint32_t valuegz_value;
    uint32_t valuem2_value;
    uint32_t valuem7_value;
    uint32_t valuem135_value;
} dataPoint_t;
...
typedef struct {
    uint8_t wBitBuf[COUNT_W_BIT];
    uint8_t valueDHT11_Temp;
    uint8_t valueDHT11_Hum;
    uint16_t valuePre;
    uint16_t valuegz_value;
    uint16_t valuem2_value;
    uint16_t valuem7_value;
    uint16_t valuem135_value;
} devStatus_t; 
